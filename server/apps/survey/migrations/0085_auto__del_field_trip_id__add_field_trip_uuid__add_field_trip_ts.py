...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'survey_trip', u'id')

        # Adding field 'Trip.uuid'
        db.add_column(u'survey_trip', 'uuid',
                      self.gf('django.db.models.fields.CharField')(default='fa3ca756-a399-4200-bc5c-6a6a58e660b3', max_length=36, primary_key=True),
                      keep_default=False)

        # Adding field 'Trip.ts'
        db.add_column(u'survey_trip', 'ts',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 11, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Trip.id'
        raise RuntimeError("Cannot reverse this migration. 'Trip.id' and its values cannot be restored.")
        # Deleting field 'Trip.uuid'
        db.delete_column(u'survey_trip', 'uuid')

        # Deleting field 'Trip.ts'
        db.delete_column(u'survey_trip', 'ts')
    ...
    models = {
        ...
        u'survey.question': {
            ...
            'logbook': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'survey.respondant': {
            ...
            'trip': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['survey.Trip']", 'null': 'True', 'blank': 'True'}),
            'ts': ('django.db.models.fields.DateTimeField', [], {}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'78dafdfd-196d-4a69-b6cf-7cc71ac43c5a'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
        ...
        u'survey.trip': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'044129fd-e861-444c-96af-f4307f1daa68'", 'max_length': '36', 'primary_key': 'True'})
        }
    }
