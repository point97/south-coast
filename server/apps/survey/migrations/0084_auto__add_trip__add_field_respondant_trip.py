...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Trip'
        db.create_table(u'survey_trip', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('start_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('end_date', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'survey', ['Trip'])

        # Adding field 'Respondant.trip'
        db.add_column(u'survey_respondant', 'trip',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Trip'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Trip'
        db.delete_table(u'survey_trip')

        # Deleting field 'Respondant.trip'
        db.delete_column(u'survey_respondant', 'trip_id')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 10, 0, 0)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'5f8cb2cc-39a8-4120-99a2-69e52fdbd1e3'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
