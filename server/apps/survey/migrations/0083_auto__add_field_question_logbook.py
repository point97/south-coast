...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.logbook'
        db.add_column(u'survey_question', 'logbook',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.logbook'
        db.delete_column(u'survey_question', 'logbook')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 8, 0, 0)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'f998f257-f7e4-401d-8417-c8423c11645c'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
